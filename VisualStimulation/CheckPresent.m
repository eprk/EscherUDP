function timestamps = CheckPresent(app,ParameterVector)
    ...
    [Blumi,Slumi,sF,Bt,p,n,OneScreenFlag,CalibrationFlag,oculusFlag,...
        ard_flag,optDtrTime] = ParameterVector{:};
...
% This vector contains two timestamps for each period, one for each 
...
% Paints the rectangle (entire screen) with equiluminant gray.
    Screen('FillRect', app.w, BaselineColor, BaselineRect)     
    Screen('Flip', app.w, timZero+Bt+2*n*p);
