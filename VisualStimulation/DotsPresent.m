...
%     BaselineScreen = app.screenRect;
    ...
    if ard_flag && PcoWhileStimFlag % prepare the additional rectangle for optical synch signal
        ...
        BaselineColorOff = cast([[basel_lumi;basel_lumi;basel_lumi],[0;0;0]],...
                                app.ScreenBitDepth);
        BaselineColor    = cast([[basel_lumi;basel_lumi;basel_lumi],[app.white; app.white; app.white]], ...
                                app.ScreenBitDepth);
    ...
    elseif ard_flag
        BaselineColor     = cast([[basel_lumi;basel_lumi;basel_lumi], [0;0;0]], ...
                                app.ScreenBitDepth);
        BaselineColor_ttl = cast([[basel_lumi;basel_lumi;basel_lumi], [app.white;app.white;app.white]], ...
                                app.ScreenBitDepth);
        BaselineScreen = [app.screenRect; app.HermesRect]';
    else
        BaselineColor = cast(basel_lumi, app.ScreenBitDepth);
