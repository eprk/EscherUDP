function scal = FastDisplayUndistortionCSV(app, caliboutfilename, screenid)
...
% %     m = dlmread(calibinfilename, ';', 1, 0);
    [vcoords,tcoords] = SphericalTransformation(app);
    scal.vcoords = vcoords;
    scal.tcoords = tcoords;
% catch %#ok<*CTCH>
%     error('Failed to load input calibration file for some reason.');
% end

fprintf('\nLoaded calibration data from screen variables.\n');
