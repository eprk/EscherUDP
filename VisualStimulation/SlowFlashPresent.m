...
if ard_flag
    StandbyColor      = cast( [StandbyLumi.*colormask, zeros(3,1)]   , app.ScreenBitDepth);
    BaselineColor     = cast( [Blumi.*colormask, zeros(3,1)]         , app.ScreenBitDepth);
    BaselineColor_ttl = cast( [Blumi.*colormask, ones(3,1)*app.white], app.ScreenBitDepth);
    StimColor         = cast( [Slumi.*colormask, zeros(3,1)]         , app.ScreenBitDepth);
    StimColor_ttl     = cast( [Slumi.*colormask, ones(3,1)*app.white], app.ScreenBitDepth);
    ...
    StimColor     = cast( Slumi.*colormask, app.ScreenBitDepth);
